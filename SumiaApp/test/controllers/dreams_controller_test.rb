...
class DreamsControllerTest < ActionController::TestCase
  ...
  test "should create dream" do
    assert_difference('Dream.count') do
      post :create, dream: { data_time: @dream.data_time, description: @dream.description, title: @dream.title }
    end
  ...
  test "should update dream" do
    patch :update, id: @dream, dream: { data_time: @dream.data_time, description: @dream.description, title: @dream.title }
    assert_redirected_to dream_path(assigns(:dream))
  end
